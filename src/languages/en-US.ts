	...
	constructor(...args: any[]) {
		...
		this.language = {
			...
			COMMAND_INVITE: (client) => [
				...
				'Please file an issue at <https://github.com/jdenderplays/Spliscord/issues> if you find any bugs.'
			],
			COMMAND_INVITE_DESCRIPTION: 'Displays the join server link of the bot.',
			COMMAND_INFO: [
				'Hey you found this; I don\'t have a info message yet so here is this.'
			],
